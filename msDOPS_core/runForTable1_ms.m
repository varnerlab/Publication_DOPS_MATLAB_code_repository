function[g_best_solution,bestparticle,particle,fitness,bestval_dds_swarm,best_particle_dds_swarm,best_particles_ls,DDS_iters]=runForTable1_ms(lowerIter,upperIter)
   ...
   for j=5:5%size(functions_to_test,2):size(functions_to_test,2)%-4
        ...
        [g_best_solution,bestparticle,particle,fitness,bestval_dds_swarm,best_particle_dds_swarm,best_particles_ls,DDS_iters]=run_DOPS_ms(functions_to_test{j},MAXJ,MINJ,lowerIter,upperIter);
    end
end
